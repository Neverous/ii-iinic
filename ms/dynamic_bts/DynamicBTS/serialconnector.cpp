...
bool SerialConnector::write_message_request(quint16 mac_address, quint8 seq_id, quint16 count, quint8 ttl)
{
	Q_ASSERT(count <= 4096);
...
bool SerialConnector::write_message_response(quint16 mac_address, quint8 assignment_ttl, quint8 len, quint64 slotmask, quint8 ttl)
{
	Q_ASSERT(len <= 64);
