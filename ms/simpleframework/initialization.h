...
void initialization_listen_until(const iinic_timing const *until)
{
    ...
    {
        handle_messages(iinic_rx_rssi, rxbuffer, iinic_buffer_ptr, INITIALIZATION_EVENT);
        iinic_rx();
    }
...
void initialization_speak_until(const iinic_timing const *until)
{
